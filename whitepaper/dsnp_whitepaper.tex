...
% Produces a footnote without any marker in the body text and without
% any number at the footnote itself.  Thanks to Grieving Gentoo in
% www.codegrepper.com/code-examples/whatever/footnote+without+number+latex
